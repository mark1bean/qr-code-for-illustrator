...
(function () {
     ...
     * @param {String} options.text - QRCode contents.
     * @param {Document} options.doc - the document in which to draw the QRCode.
     * @param {Number} [options.left=0] - left position of the QRCode.
     * @param {Number} [options.top=0] - top position of the QRCode.
     * @param {Number} [options.width=256] - width of the QRCode, in points.
     * @param {Number} [options.height=256] - height of the QRCode, in points.
    ...
    QRCode.prototype.draw = function (qrcode) {
        ...
        if (options.joinSquares) {
            ...
            options.doc.selection = [group];
            app.executeMenuCommand('Live Pathfinder Add');
            app.executeMenuCommand('expandStyle');
            group = options.doc.selection[0];
    ...
    /**
     * Draws a rectangle.
     * @param {Document|GroupItem} container - an Illustrator document.
     * @param {Array<Number>} rect - [left, top, width, height].
